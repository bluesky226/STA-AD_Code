...
class MLPWithInputSkips(nn.Module):
    def __init__(self, config_dict,
        ...
        for layeri in range(n_layers) : 
            ...
            batch_norm = nn.BatchNorm1d(dimout)
            layers.append(nn.Sequential(linear, batch_norm, torch.nn.ReLU(True)))
            ...
            print('===Batch norm status - , config_dict[mlp_batch_norm] :',config_dict['mlp_batch_norm'])
