...
class Main(object):
    ...
    def setup_experiment(self):
        ...
        wandb.init(project='23_RA_MIDL_S2_AD', config=config_dict)
...
def add_args(parser):
    ...
    parser.add_argument('--config_path', type=str, default='./projects/23_uad_review/configs/fast_mri/s2_localization_ra.yaml', metavar='C',
