...
class Main(object):
    ...
    def setup_experiment(self):
        ...
        wandb.init(project='RA-baselines', config=config_dict)
...
def add_args(parser):
    ...
    parser.add_argument('--config_path', type=str, default='/home/sameer/code/c-b/RA/projects/23_uad_review/configs/fast_mri/test_ra_size.yaml', metavar='C',
