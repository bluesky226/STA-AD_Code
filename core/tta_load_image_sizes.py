...
class Main(object):
    ...
    def setup_experiment(self):
        ...
        wandb.init(project=exp_name, config=config_dict)
...
def add_args(parser):
    ...
    parser.add_argument('--config_path', type=str, default='/home/sameer/code/c-b/RA/projects/23_uad_review/configs/fast_mri/tta_load_image_sizes.yaml', metavar='C',
