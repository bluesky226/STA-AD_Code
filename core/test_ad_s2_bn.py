...
class Main(object):
    ...
    def setup_experiment(self):
        ...
        wandb.init(project='23_RA_MIDL_S2', config=config_dict)
...
def add_args(parser):
    ...
    parser.add_argument('--config_path', type=str, default='/home/sameer/code/c-b/RA/projects/23_uad_review/configs/fast_mri/psi_tta_ad_s2_bn.yaml', metavar='C',
