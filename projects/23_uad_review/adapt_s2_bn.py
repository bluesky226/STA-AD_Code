...
from latent_ir.scripts import optimization_bn as optimization_ir_bn
    ...
    def pathology_localization(self, global_model, threshold_low, threshold_high, perc_flag=False, params_dict=None):
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in enumerate(dataset):
                ...
                outputs, outputs_np_img, o_img_1 = optimization_ir_bn.run_style_mlp(context_img, style_img, config_dict, iter)
    ...
    def healthy_recons(self, global_model, threshold_low, threshold_high, perc_flag=False, params_dict=None):
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in enumerate(dataset):
                ...
                outputs, outputs_np_img, o_img_1, model_weights = optimization_ir_bn.run_style_mlp(context_img, style_img, config_dict, iter, model_weights)
