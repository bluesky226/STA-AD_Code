...
class PDownstreamEvaluator(DownstreamEvaluator):
    ...
    def start_task(self, global_model, params_dict):
        ...
        _ = self.thresholding(global_model, params_dict)
    ...
    def thresholding(self, global_model, config_dict):
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in enumerate(dataset):
                ...
                x_rec = tta_neural.tta_neural_style_transfer(x_rec_org, x, cd, idx)
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in enumerate(dataset):
                ...
                for i in range(len(x)):
                    ...
                    x_i = x[i][0]
                    x_rec_i = x_rec[i][0]
                    x_res_i, _, _ = self.model.get_anomaly_ir(x_rec_i, x_i)
