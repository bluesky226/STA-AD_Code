...
class PDownstreamEvaluator(DownstreamEvaluator):
    ...
    def start_task(self, global_model, params_dict=None):
        ...
        print('Calling only 0, -1 ')
        
        self.pathology_localization(global_model, -1, 1, True, params_dict)
        ...
        for dataset_key in self.test_data_dict.keys():
            ...
            for idx, data in enumerate(dataset):
                ...
                to_visualize = [
                    ...
                    {'title': f'Residual map theta {value_res:.3f}', 'tensor': x_rec_org_res, 'cmap': 'plasma',
                        'vmax': 0.4},
                    
                    {'title': f'Residual map ns {value_res:.3f}', 'tensor': output_x_res, 'cmap': 'plasma',
                        'vmax': 0.4},
