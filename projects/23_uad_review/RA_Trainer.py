...
class PTrainer(Trainer):
    ...
    def __init__(self, training_params, model, data, device, log_wandb=True):
        ...
        self.scale = 1 / (training_params['input_size'][1] ** 2)  
        self.gamma_r = 1e-8
        self.beta_kl = 1.0
        self.beta_rec = 0.5
        self.beta_neg = 128.0
    ...
    def train_phi(self, model_state=None, opt_state=None, start_epoch=0):
        ...
        model_name = 'vgg16'
        phi_model , a, b = prepare_model(model_name, device)
